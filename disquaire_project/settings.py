...
SECRET_KEY = os.environ.get('SECRET_KEY', 'voosoftfz$w8jyt-6-tttyk^$mvk0mpeytypm-#6^39^4q37zl6c5kkxodev')
# '-~aO;| F;rE[??/w^zcumh(9'
...
DATABASES = {
    'default': {
        ...
        'USER': 'clienard', # attention : remplacez par votre nom d'utilisateur !!
        'PASSWORD': 'bdeux',
        'HOST': 'localhost',
        'PORT': '5432',
    }
